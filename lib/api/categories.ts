...
export const createCategory = (name: string) => apiMutate<Category>('POST', 'categories', { name });
...
export const archiveCategory = (id: string) => apiMutate<null>('POST', `categories/${id}/archive`);
